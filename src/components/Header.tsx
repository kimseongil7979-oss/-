...
export default function Header({ onAdminToggle, isAdminOpen }: HeaderProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col">
      ...
      <header
        id="site-header"
        className={`w-full relative transition-all duration-300 h-14 md:h-20 flex items-center ${
          scrolled
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10 w-full flex justify-between items-center">
          ...
          >
            <div className={`w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center font-bold text-lg md:text-xl transition-all duration-300 ${
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              id="header-call-btn"
              href="tel:010-4122-7980"
              className="flex items-center gap-2 bg-[#0051e0] text-white px-3 py-1.5 md:px-3.5 md:py-2 rounded-lg font-bold shadow-md hover:bg-blue-700 active:scale-[0.98] transition-all duration-200 text-xs md:text-sm cursor-pointer"
            >
            ...
            <button
              ...
              className={`md:hidden p-1.5 rounded-lg border transition-colors duration-300 ${
                scrolled
        ...
        {/* Mobile Dropdown Menu (Absolute positioned relative to header) */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 w-full bg-white text-slate-900 border-b border-slate-100 shadow-xl px-6 py-4 flex flex-col gap-4 animate-in slide-in-from-top duration-200">
