...
export default function AIChatbot() {
  ...
  return (
    <>
      ...
      {/* Floating Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-36 md:bottom-24 right-4 md:right-6 w-[92vw] sm:w-[420px] h-[550px] bg-white rounded-3xl shadow-2xl border border-slate-100 flex flex-col justify-between overflow-hidden z-50 animate-scale-up">
