...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex fixed right-0 top-1/3 -translate-y-1/2 z-40 bg-[#e31837] text-white pl-3.5 pr-2 py-4 rounded-l-xl shadow-2xl flex flex-col items-center gap-2 font-bold text-xs tracking-tight hover:bg-red-700 transition-all cursor-pointer group hover:pl-5 select-none"
